...
function AuthPage() {
	return (
		<div className="px-10">
			<div className="flex max-sm:flex-col max-w-md max-sm:h-[30rem] h-[30rem] mx-auto bg-base-200 rounded-2xl overflow-hidden my-20">
				<ToggleForms />
				...
				<div className="flex-1 relative transition-all max-sm:max-h-[5rem] max-sm:peer-checked:max-h-[100%] max-sm:w-full sm:max-w-[5rem] peer-checked:max-w-[100%] p-10">
					...
					<Link
						...
						id="show-signup"
						className="bg-primary text-center text-white text-sm py-1 !rounded-xl max-sm:!rounded-t-none sm:!rounded-b-none sm:rotate-90 absolute left-1/2 sm:left-0 top-5 sm:top-1/2 max-sm:-translate-x-1/2 sm:-translate-y-1/2"
					>
						Show Signup
					</Link>
				</div>
