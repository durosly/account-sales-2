		...
		<>
			...
			<div className="px-10 space-y-3 mb-20">
				...
				<p>
					...
					terminate all future orders, ban you from the website. We
					also reserve the right to take away any followers or likes
					we delivered to you or your clients
					Instagram/Facebook/Twitter or other social media account. If
					your orders are placed rightly and for any reason you did
					not get the value for your service ( NOTE : Every order has
					a start count, sometimes start count can be delayed due to
					server issue but will definitely be delivered), kindly
					contact support if you think your order is taking too long (
					Depends on the start count ), you will receive a refund
					credit to your Owlet account if the order is
					non-deliverable. Lost or Private account orders will not
					qualify for a refund, kindly make sure to confirm each and
					every order before placing it, go through our FAQSto learn
					more about how to place orders rightly. Fraudulent activity
					such as using unauthorized or stolen credit cards will lead
					to termination of your account and you will be reported to
					the ANTI FRAUD SQUAD. Please do not use more than one server
					at the same time for the same page : Every order has a start
					and end count, using two or more server at the same time
					will disrupt the start and end count, hence, you will not
					get the correct number of service paid for. NOTE : No refill
					or Refund If link get broken or the profile is
					disabled/deleted/deactivated/banned or If username is
					changed.
				</p>
				<h2 className="text-secondary uppercase">PRIVACY</h2>
				This policy covers how we use your Personal Information. We take
				your privacy seriously and will take all measures to protect
				your personal information. Any personal information received
				will only be used to fill your order. We will not sell or
				redistribute your information to anyone. All information is
				...
				<ul className="list-disc">
					...
					<li>
						...
						website, and customise the website to your account;
					</li>
					<li>
						To send you promotional information, such as
						newsletters. Each e-mail newsletter will provide
						information on how to opt-out of future mailings by
						unsubscribing;
					</li>
					<li>
					...
					<li>
						To review the effectiveness of our marketing programs
						and analyse other general demographic trends;
					</li>
					<li>
						To notify you of new information or services that may be
						of interest to you; or,
					</li>
				...
				<div className="space-y-3">
					...
					<p>
						Parent Companies and Affiliates: We may share your
						information with a parent company, any subsidiaries,
						joint ventures, or other companies under a common
						control (collectively, “Affiliates”), provided that we
						require our Affiliates to honor this Privacy Policy.
					</p>
					<p>
						Related Companies: We may also share your Personal Data
						with our Related Companies for purposes consistent with
						this Privacy Policy.
					</p>
					<p>
						Third Parties with Permission: We may share your
						information with third parties to whom you ask us to
					...
					<p>
						...
						employ another entity to perform a function of this
						nature, we only provide them with the information that
					...
					<p>
						...
						investigations or alleged illegal activity or in
						connection with our own investigation of suspected or
						...
						investigate problems, or enforce our Customer contracts.
					</p>
				</div>
				<h2 className="uppercase font-semibold">Log Data</h2>
				<p>
				...
				<p>
					In addition to other restrictions outlined in these Terms,
				...
				<ul className="list-disc">
					...
					<li>Compromise security of the Service;</li>
					<li>
						Send any unsolicited advertising, spam or any other
						unauthorised promotional materials;
					</li>
					<li>Create fake orders to cheat the system</li>
				</ul>
				<h2 className="uppercase font-semibold">Other Conditions</h2>
				<ul className="list-disc">
					<li>
						We reserve the right to terminate the Service at any
						time.
					</li>
					<li>
					...
					<li>
						At our at our sole discretion we reserve the right to
						remove any content if we determine, in our sole
						discretion, it to be unlawful, offensive, threatening or
						violating third party copyrights.
					</li>
				</ul>
				<h2 className="uppercase font-semibold">Cookies</h2>
				<p>
					...
					your computer&apos;s hard drive. Our website uses these
